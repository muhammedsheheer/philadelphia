...
const BavetteStory = ({}) => {
  return (
    <section className="relative flex h-full w-full items-center justify-center p-4 lg:py-16">
      <div className="flex h-full w-full flex-col items-center justify-center gap-11 bg-[#0D3F47]">
        <h2 className="font-oswald text-center text-8xl text-[#fff] md:left-[15%] md:text-8xl">
          The La Turka
          <br />
          Story
        </h2>
        <div className="flex h-full w-full flex-col items-center justify-center gap-4 bg-[#0D3F47] md:flex-row lg:px-24 lg:py-20">
          ...
          <div className="flex h-full w-full flex-col items-center gap-[2.5rem] p-6 md:w-1/2 md:items-start lg:ml-24">
            ...
            <p className="max-w-[450px] text-center font-light leading-[160%] text-[#f7f5f1] md:text-start">
