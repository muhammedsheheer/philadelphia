...
const Special = ({}) => {
  ...
  return (
    <section
      className="relative flex h-full w-full justify-center py-12 lg:py-24"
      style={{
      ...
      <div className="flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-4 py-12">
        <div className="flex w-full flex-col items-center justify-center gap-3 md:flex-row">
          <div className="flex flex-col gap-2">
            <h1 className="text-center font-bebas text-6xl font-[400] uppercase text-[#FF8A00] lg:text-9xl">
              Featured
            </h1>
          </div>
        </div>
