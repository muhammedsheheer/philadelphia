...
const Success: FC<SuccessProps> = ({ id }) => {
    ...
    if (!data) {
        return (
            <div className="w-full h-full flex flex-col items-center justify-center gap-5 bg-menubackground">
                <p className="font-[600] text-4xl tracking-[2px] text-menuprimary">Placing your order...</p>
                <Image
    ...
    return (
        ...
        <section className="relative flex h-full w-full flex-col bg-menubackground md:px-[130px]">
            ...
            <div className="w-full flex justify-end px-7 py-6 bg-menubackground">
                <Link
                    href="https://foodo.ai"
